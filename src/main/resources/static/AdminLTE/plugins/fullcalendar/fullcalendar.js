...
var Grid = fc.Grid = RowRenderer.extend({
	...
	// Tells the grid about what period of time to display. Grid will subsequently compute dates for cell tool.
	...
	// Generates an array of classNames for rendering the highlight. Used by the fill tool.
...
Grid.mixin({
	...
	// Renders a background event element, given the default rendering. Called by the fill tool.
	...
	// Generates an array of classNames to be used for the rendering business hours overlay. Called by the fill tool.
...
DayGrid.mixin({
	...
	renderSegPopoverContent: function(cell, segs) {
		...
		for (i = 0; i < segs.length; i++) {
			...
			// because segments in the popover are not part of a grid coordinate tool, provide a hint to any
...
function EventManager(options) { // assumed to be a calendar
	...
	// TODO: make this a part of the event -> eventRange tool
